    ...
    >
      ...
      {items.length === 0 && step !== "success" ? (
        ...
        >
          ...
          <p
            style={{ fontFamily: "Arial", color: "#666", marginBottom: "2rem" }}
          >
        ...
        >
          ...
          >
            ...
            >
              Thank you for choosing Ghunghat.
            </p>
            <p
              style={{
                fontFamily: "Arial",
            ...
            >
              Your order confirmation has been sent. Expected delivery: 3–5
              business days.
            </p>
            <div
              style={{
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontFamily: "Arial",
                        fontSize: "0.6rem",
                        color: step === s ? "#B8860B" : "rgba(255,248,231,0.5)",
                        textTransform: "uppercase",
                        letterSpacing: "0.1em",
                      }}
                    >
            ...
            {step === "payment" && (
              ...
              >
                  ...
                  {["upi", "card", "cod"].map((method) => (
                    <button
                      ...
                      style={{
                        ...
                        border: `2px solid ${payMethod === method ? "#B8860B" : "#E8D5A3"}`,
                        backgroundColor:
                          payMethod === method ? "#FFF8E7" : "#fff",
                        borderRadius: "8px",
                        cursor: "pointer",
                        textAlign: "left",
                        transition: "all 0.2s",
                ...
                {payMethod === "cod" && (
                  ...
                  >
                    Pay ₹{grandTotal.toLocaleString("en-IN")} in cash when your
                    order arrives. No advance payment needed.
                  </p>
                )}
              ...
              >
                ...
                >
                  ...
                  <span>
                    ₹
                    {items
                      .reduce((s, i) => s + i.mrp * i.quantity, 0)
                ...
                >
                  <span>Delivery</span>
                  <span style={{ color: delivery === 0 ? "#2E7D32" : "#555" }}>
