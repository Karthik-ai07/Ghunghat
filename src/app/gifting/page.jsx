...
const giftSets = [
  {
    ...
    badge: "Bestseller",
    desc: "A complete skincare ritual for luminous, hydrated skin.",
  },
  {
    id: "gf-002",
    name: "Ayurvedic Indulgence Box",
    price: 2199,
    mrp: 2999,
    img: "/products/kumkumadi.png",
    items: ["Kumkumadi Tailam", "Saffron & Honey Night Balm", "Neem Face Pack"],
    badge: "Most Gifted",
    desc: "Ancient Ayurvedic formulas beautifully presented as a gift.",
  },
  {
    id: "gf-003",
    ...
    badge: "Exclusive",
    desc: "Everything a bride needs for her most radiant look.",
  },
  {
    id: "gf-004",
    ...
    badge: "Great Value",
    desc: "Daily essentials curated for a complete skincare routine.",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Beautifully curated gift sets for every occasion — birthdays,
          weddings, festivals & more.
        </p>
        <div
          style={{
            display: "flex",
          ...
          {giftSets.map((g) => (
            <div
              ...
              style={{
                ...
                borderRadius: "12px",
                overflow: "hidden",
                boxShadow: "0 2px 20px rgba(139,0,0,0.08)",
                display: "flex",
                gap: 0,
              }}
            >
              ...
              >
                <Image
                  src={g.img}
                  alt={`Ghunghat Premium Gift set — ${g.name}`}
                  fill
